...
class Blocks {
	...
	public function get_available_blocks() {
		return array(
			...
			'bengal-studio/recent-jobs'   => array(
				'attributes'      => array(
					'className'          => array(
						'type' => 'string',
					),
				...
				'render_callback' => array( $this, 'render_recent_jobs' ),
			),
		);
	}
	...
	/**
	 * Renders the `bengal-studio/recent-jobs` block on server.
	 * @param  [type] $attributes [description]
	 * @return [type]             [description]
	 */
	public function render_recent_jobs( $attributes ) {
		wp_enqueue_style( 'wp-job-manager-job-listings' );
